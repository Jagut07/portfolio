...
import { motion } from "framer-motion";
 import mylogo from "./Images/mylogo.jpg.jpeg"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-slate mb-4">
              Hello! I'm Jagrut Vijay Das, an aspiring web developer passionate about crafting engaging and user-friendly websites.
            </p>
            <p className="text-slate mb-4">
